            ...
            <div class="col-lg-6">
                ...
                <form:form action="/register" method="post" modelAttribute="newUser" class="mb-4">
                    ...
                    <div class="form-group" >
                        ...
                        <form:input class="form-control" aria-labelledby="passwordHelpBlock" path="password" />
                        <form:errors path="password"/>
                    </div>
                    <div class="form-group">
                        <form:label path="confirm">Confirm Password</form:label>
                        <form:input class="form-control" aria-labelledby="passwordHelpBlock" path="confirm"/>
