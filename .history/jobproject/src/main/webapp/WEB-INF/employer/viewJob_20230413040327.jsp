            ...
            <tbody>
                <c:forEach items="${applications}" var="application">
                    <c:if test="${not empty applications}">
                        <tr>
                            <td><br>${application.applicant.userProfile.firstName} ${application.applicant.userProfile.lastName}<br></td>
                            <td><br>${application.applicant.email}</td>
                            <td><br>${application.applicationStatus}</td>
                            <td>
