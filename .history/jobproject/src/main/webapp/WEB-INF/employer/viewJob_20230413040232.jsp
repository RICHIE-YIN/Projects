            ...
            <tbody>
                <c:forEach items="${applications}" var="application">
                    <c:if test="${not empty applications}">
                        <tr>
                            <td><br><br>${application.applicant.userProfile.firstName} ${application.applicant.userProfile.lastName}</td>
                            <td><br><br>${application.applicant.email}</td>
                            <td><br><br>${application.applicationStatus}</td>
                            <td>
