...
<head>
    ...
    <link rel="stylesheet" href="/jobproject/src/main/resources/static/styles.css" />
...
<body>
            ...
            <tbody>
                <c:forEach items="${applications}" var="application">
                    <c:if test="${not empty applications}">
                        <tr>
                            <td><br><h4><strong>${application.applicant.userProfile.firstName} ${application.applicant.userProfile.lastName}</strong></h4></td>
                            <td><br><h4><strong>${application.applicant.email}</strong></h4></td>
                            <td><br><h4><strong>${application.applicationStatus}</strong></h4></td>
                            <td>
    ...
    <c:if test="${isJobCreator}">
        <a href="/employer/editjob/${job.id}" class="btn btn-primary mt-3">Edit Job</a>
    </c:if>
</div>
