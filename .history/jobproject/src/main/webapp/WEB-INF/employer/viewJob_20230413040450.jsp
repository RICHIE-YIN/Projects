            ...
            <tbody>
                <c:forEach items="${applications}" var="application">
                    <c:if test="${not empty applications}">
                        <tr>
                            <td><br><h4><strong>${application.applicant.userProfile.firstName} ${application.applicant.userProfile.lastName}</h4></strong></td>
                            <td><br><strong>${application.applicant.email}</strong></td>
                            <td><br><strong>${application.applicationStatus}</strong></td>
                            <td>
