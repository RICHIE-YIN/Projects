...
# @app.route('/conversation/<int:contact_id>/product/<int:product_id>', methods=['GET'])
# def view_conversation(contact_id, product_id):
#     if not 'user_id' in session:
#         return redirect('/')
...
#     product = ProductListing.get_one({'id': product_id})
#     messages = Message.get_messages_for_conversation(user.id, contact.id, product.id)
