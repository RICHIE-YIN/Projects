...
class UserProfile:
    def __init__(self, data, profile_picture=None):
        ...
        if profile_picture:
            self.profile_picture = base64.b64encode(profile_picture).decode('utf-8')
        else:
    ...
    def create(cls, data, profile_picture_data):
        ...
        if profile_picture_data:
            encoded_picture = base64.b64encode(profile_picture_data)
            data['profile_picture'] = encoded_picture
    ...
    def get_one(cls, data):
        ...
        if profile_data['profile_picture']:
            profile_picture = base64.b64decode(profile_data['profile_picture'])
        return cls(profile_data, profile_picture)
