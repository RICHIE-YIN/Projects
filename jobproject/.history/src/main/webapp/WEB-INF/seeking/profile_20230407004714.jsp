...
<body>
    ...
    <c:if test="${userProfile == null}">
        ...
        <form:form action="/userprofile/create" method="POST" modelAttribute="newUserProfile">
            ...
            <p><form:input type="number" path="phoneNumber" placeholder="Phone Number" /></p>
            <p><form:input path="address" placeholder="Address" /></p>
            <p><form:input path="city" placeholder="City" /></p>
            <p><form:input path="state" placeholder="State" /></p>
            <p><form:input path="country" placeholder="Country" /></p>
            <p><form:input path="summary" placeholder="Summary" /></p>
            <p><form:input path="skills" placeholder="Skills" /></p>
            <p><form:input path="languages" placeholder="Languages" /></p>
            <p><form:input path="availability" placeholder="Availability" /></p>
